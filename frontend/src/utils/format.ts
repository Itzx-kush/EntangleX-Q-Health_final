...
export const modelLabels = {logistic_regression: 'Logistic Regression', svm: 'SVM', random_forest: 'Random Forest', vqc: 'VQC', qsvc: 'QSVC', qnn: 'QNN'} as const;
export const isQuantum = (model: string | null | undefined): boolean => model === 'vqc' || model === 'qsvc' || model === 'qnn';
